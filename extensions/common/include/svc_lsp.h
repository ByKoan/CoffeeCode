 ...
 *
 * Define la vtable que una extension proveedora (p.ej. vesta-lsp) publica con
...
typedef struct CoffeeSvcLsp {
    ...
    /**
     * @brief Lanza una peticion LSP (o vesta/* custom) de forma sincrona-logica.
     *
     ...
     *
     * @param self        Estado opaco del proveedor.
     * @param method      Metodo LSP, p.ej. "textDocument/hover" o "vesta/bytecode".
